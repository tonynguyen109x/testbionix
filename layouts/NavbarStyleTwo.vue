                        ...
                        <ul class="navbar-nav">
                            <li class="nav-item">
                                ...
                                <ul class="dropdown-menu">
                                    <li class="nav-item">
                                        <NuxtLink to="/" class="nav-link">Home One</NuxtLink>
                                    </li>
                                    <li class="nav-item">
                                        <NuxtLink to="/home-two" class="nav-link">Home Two</NuxtLink>
                                    </li>
                                    <li class="nav-item">
                                        <NuxtLink to="/home-three" class="nav-link">Home Three</NuxtLink>
                                    </li>
                                    <li class="nav-item">
                                        <NuxtLink to="/home-four" class="nav-link">Home Four</NuxtLink>
                                    </li>
                                    <li class="nav-item">
